...
export type Item = {
  carts?: Maybe<CartRelationResponseCollection>;
...
export type ItemInput = {
  carts?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
  ...
  items?: {
    data: Array<{
      ...
      attributes?: {
        ...
        description: string;
        price: number;
        image: { data: Array<{ attributes?: { url: string } | null }> };
      } | null;
    }>;
  } | null;
};
...
export type LoginMutation = {
  login: { jwt?: string | null; user: { id: string; email?: string | null } };
};
